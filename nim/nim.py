...
class NimAI():
    ...
    def best_future_reward(self, state):
        ...
        # Convert state to tuple for dictionary key
        state_key = tuple(state)
        available_actions = Nim.available_actions(state_key)
    ...
    def choose_action(self, state, epsilon=True):
        ...
        for action in available_actions:
            ...
            if q_value > max_q:  # Found a new best action
                max_q = q_value
                best_actions = [action]  # Start a new list of best actions
            elif q_value == max_q:
                best_actions.append(action) # Add to the list of best actions

        # Return a random best action among those with the highest Q-value
